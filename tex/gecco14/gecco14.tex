...
\red{todle se dá dát asi na začátek crossover operation spíš, nebo nevim}
...
\red{to furt platí, protože na s-výrazy se eta redukce ani abstr elim nevztahuje}
...
\red{CO S @-stromama řešit je explicitně tady, případně někde jinde? Pro generování nemá reprezentace vliv, ta má vliv až vpři křížení, kde at-tree zajišťuje víc míst. We will show how to crossover \textit{typed \lterm trees} in both \atTree and \sexprTree notation.}
